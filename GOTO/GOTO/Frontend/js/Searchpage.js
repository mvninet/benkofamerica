...
function showParcelData() {
    var temp = document.getElementById("ParcelData");
    var clon = temp.content.cloneNode(true);
    document.getElementById("parcelData").appendChild(clon);
}
...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        //a.setAttribute("style", "margin: 8px 2px");
...
function initialize() {
    ...
    showParcelData();
    showParcelType();
    autocomplete(document.getElementById("autoFrom"), countries);
    autocomplete(document.getElementById("autoTo"), countries);

    //document.getElementsByClassName("popoverIcon1").addEventListener("click", popOver());
